...
CREATE TABLE "upload_routing_policies" (
    ...
    "priority_account_ids" TEXT NOT NULL DEFAULT '[]',
...
CREATE TABLE "connected_accounts" (
    ...
    CONSTRAINT "connected_accounts_provider_config_id_fkey" FOREIGN KEY ("provider_config_id") REFERENCES "provider_configs" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
